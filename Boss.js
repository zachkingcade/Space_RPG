class Boss extends Phaser.Scene {
    ...
    create() {
        ...
        //add main background
        let background = this.add.image(-125, 0, "11_boss");
    ...
    enemyAttack() {
        ...
        if (this.enemyAttackCooldown < 1) {
            ...
            this.cameras.main.shake(150, 0.10);
            this.bossRemoveRows();
        }
        if (this.player.health < 1) {
            this.onGameOver();
